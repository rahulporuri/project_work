...
numpy.savetxt('data_files/squeezed_limit.dat', data)
...
plt.savefig('plots/tps_vs_k_sq.png')
...
plt.legend([python],['python'])
plt.savefig('plots/calG_vs_k_sq.png')
'''
plt.cla()
plt.xlabel(r'$k$')
...
plt.legend([python],['python'])
plt.savefig('plots/k32calG_vs_k_sq.png')
'''
plt.cla()
plt.xlabel(r'$k$')
plt.ylabel(r'G')
...
plt.legend([python],['python'])
plt.savefig('plots/G_vs_k_sq.png')
...
plt.legend([python],['python'])
plt.savefig('plots/k6G_vs_k_sq.png')
...
plt.legend([python],['python'])
plt.savefig('plots/h_NL_vs_k_sq.png')
