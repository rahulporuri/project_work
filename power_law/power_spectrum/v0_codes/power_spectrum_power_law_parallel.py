...
tps_file = open('power_spectrum_power_law_5.dat','w')
phi_file = open('phi_vs_N_power_law_5.dat','w')
h_file = open('H_vs_N_power_law_5.dat','w')
eps_file = open('eps1_vs_N_power_law_5.dat','w')
...
# nics and nshss should be obtained through functions
...
# initialization should be done through functions
...
# evolution of hk should be done through functions
...
TPS = [8*(k)**3/(2*numpy.pi**2)*(numpy.absolute(k_vs_hk[i+1]))**2 for i in enumerate(k_list)]
print k_list, TPS
